...
```{r, fig.align='right', out.width='42%'}
knitr::include_graphics('convolution.gif')
```
...
eqns %>% tail(3) %>% knitr::kable(format='html',escape=FALSE)
```
...
knitr::include_graphics('fig1-1.png')
```
...
tb1 %>% 
  ...
  annotate(geom='text',x=0.75,y=0.4, label='d[1]==0.201',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.35,label='s[1]==0.799',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.3, label='s[2]==0.994',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.25,label='s[3]==0.987',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.2, label='GCSM==0.784',parse=T,size=6)+
  
  annotate(geom='text',x=0.25,y=0.6, label='d[1]==0.040',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.55,label='s[1]==0.960',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.5, label='s[2]==0.994',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.45,label='s[3]==0.987',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.4, label='CMSC==0.942',parse=T,size=6)+
  xlim(0,1)+ylim(0,1)+
  theme_bw(14)
tb2 %>% 
  ggplot()+aes(x,y)+
  ...
  annotate(geom='text',x=0.25,y=0.4, label='d[1]==0.201',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.35,label='s[1]==0.799',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.3, label='s[2]==0.994',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.25,label='s[3]==-0.987',parse=T,size=6)+
  annotate(geom='text',x=0.25,y=0.2, label='GCSM==-0.784',parse=T,size=6)+
  
  annotate(geom='text',x=0.75,y=0.6, label='d[1]==0.001',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.55,label='s[1]==0.999',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.5, label='s[2]==0.994',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.45,label='s[3]==-0.987',parse=T,size=6)+
  annotate(geom='text',x=0.75,y=0.4, label='CMSC==-0.980',parse=T,size=6)+
  xlim(0,1)+ylim(0,1)+
  theme_bw(14)
```
