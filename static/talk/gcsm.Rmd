...
tibble(diff=seq(0,1,length.out=256),cmsc=1-diff^2,gcsm=1-diff) %>% 
  ...
  geom_line()+scale_color_grey(start=0.8,end=0.2)+
...
tb2 %>% 
  ...
  annotate(geom='text',x=0.25,y=0.3,label='r[1]==0.799',parse=T,size=8)+
  xlim(0,1)+ylim(0,1)+
  theme_bw()
```
...
### II: Associatino between GPP and precipitation
